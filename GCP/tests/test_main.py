...
def test_main_flow(
    mock_processor_cls, mock_bq_client_cls, mock_ps_client_cls, mock_config_json
):
    ...
    mock_processor.calculate_mandatory_spending.return_value = {
        "grand_total_annual": 100
    }
