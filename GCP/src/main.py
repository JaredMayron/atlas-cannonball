...
def main():
    ...
    ps_client = PocketSmithClient(api_key, user_id)
    ...
    try:
        ...
        accounts = ps_client.get_accounts()
        ...
        transactions = ps_client.get_transactions_past_year()
        mandatory_spending = processor.calculate_mandatory_spending(transactions)

        # 4. Calculate Runway
        logger.info("Calculating financial runway...")
        runway_metrics = processor.calculate_runway(categorized_accounts, mandatory_spending)
